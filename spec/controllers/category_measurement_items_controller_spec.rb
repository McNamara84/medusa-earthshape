...
describe CategoryMeasurementItemsController do
  ...
  describe "POST move_to_top" do
    ...
    before do
      request.env["HTTP_REFERER"]  = "/measurement_categories/#{category_measurement_item.measurement_category_id}"
  ...
  describe "DELETE destroy" do
    ...
    before do
      request.env["HTTP_REFERER"]  = "/measurement_categories/#{measurement_category.id}"
      category_measurement_item
