class NestedResources::PreparationsController < ApplicationController
  ...
  def create
    ...
    respond_with @preparation, location: safe_referer_url_with_requested_tab, action: "error"
  end

  def update
    @preparation= Preparation.find(params[:id])
    @parent.preparations << @preparation
    respond_with @preparation, location: safe_referer_url_with_requested_tab
  end
