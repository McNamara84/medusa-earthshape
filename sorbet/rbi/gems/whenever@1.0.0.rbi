...
class Whenever::NumericSeconds
  ...
  # source://whenever//lib/whenever/numeric_seconds.rb#31
  def day; end

  # source://whenever//lib/whenever/numeric_seconds.rb#28
  def days; end

  # source://whenever//lib/whenever/numeric_seconds.rb#26
  def hour; end

  # source://whenever//lib/whenever/numeric_seconds.rb#23
  def hours; end

  # source://whenever//lib/whenever/numeric_seconds.rb#21
  def minute; end

  # source://whenever//lib/whenever/numeric_seconds.rb#18
  def minutes; end

  # source://whenever//lib/whenever/numeric_seconds.rb#41
  def month; end
  ...
  # source://whenever//lib/whenever/numeric_seconds.rb#16
  def second; end

  # source://whenever//lib/whenever/numeric_seconds.rb#13
  def seconds; end

  # source://whenever//lib/whenever/numeric_seconds.rb#36
  def week; end

  # source://whenever//lib/whenever/numeric_seconds.rb#33
  def weeks; end

  # source://whenever//lib/whenever/numeric_seconds.rb#46
  def year; end
