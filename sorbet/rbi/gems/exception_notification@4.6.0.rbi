...
module ExceptionNotifier
  ...
  class << self
    # source://exception_notification//lib/exception_notifier.rb#87
...
class ExceptionNotifier::TeamsNotifier < ::ExceptionNotifier::BaseNotifier
  ...
  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#99
  def activity_title; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#126
  def additional_exception_data; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#171
  def controller_and_method; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#87
  def details; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#199
  def env_name; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#143
  def gitlab_issue_link; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#133
  def gitlab_view_link; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#179
  def hash_presentation(hash); end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#161
  def jira_issue_link; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#113
  def message_backtrace(size = T.unsafe(nil)); end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#106
  def message_request; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#64
  def message_text; end

  # source://exception_notification//lib/exception_notifier/teams_notifier.rb#189
  def rails_app_name; end
