...
# This is an autogenerated file for types exported from the `kt-paperclip` gem.
# Please instead update this file by running `bin/tapioca gem kt-paperclip`.


# The base module that gets included in ActiveRecord::Base. See the
# documentation for Paperclip::ClassMethods for more useful information.
#
# source://kt-paperclip//lib/paperclip/version.rb#1
module Paperclip
  ...
  class << self
    # source://kt-paperclip//lib/paperclip.rb#109
    def io_adapters; end

    # source://kt-paperclip//lib/paperclip.rb#105
    ...
    #   }
    #
    # source://kt-paperclip//lib/paperclip/missing_attachment_styles.rb#60
    ...
    #
    # source://kt-paperclip//lib/paperclip.rb#90
    def options; end

    # source://kt-paperclip//lib/paperclip/missing_attachment_styles.rb#7
    ...
    #
    # source://kt-paperclip//lib/paperclip/missing_attachment_styles.rb#6
    def registered_attachments_styles_path=(_arg0); end

    # source://kt-paperclip//lib/paperclip/missing_attachment_styles.rb#20
    ...
    #   }
    #
    # source://kt-paperclip//lib/paperclip/missing_attachment_styles.rb#35
    def current_attachments_styles; end

    # Get list of styles saved on previous deploy (running rake paperclip:refresh:missing_styles)
    #
    # source://kt-paperclip//lib/paperclip/missing_attachment_styles.rb#13
    def get_registered_attachments_styles; end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#4
class Paperclip::AbstractAdapter
  # @return [AbstractAdapter] a new instance of AbstractAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#11
  def initialize(target, options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#45
  def assignment?; end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#8
  ...
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#7
  def content_type; end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#8
  def eof?(*_arg0, **_arg1, &_arg2); end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#16
  def fingerprint; end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#31
  def inspect; end

  # Returns the value of attribute size.
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#9
  def length; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#41
  def nil?; end
  ...
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#35
  def original_filename=(new_filename); end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#8
  def path(*_arg0, **_arg1, &_arg2); end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#27
  ...
  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#55
  def copy_to_tempfile(src); end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#51
  def destination; end

  # source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#60
  def link_or_copy_file(src, dest); end
end

# source://kt-paperclip//lib/paperclip/io_adapters/abstract_adapter.rb#5
Paperclip::AbstractAdapter::OS_RESTRICTED_CHARACTERS = T.let(T.unsafe(nil), Regexp)

# source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#2
class Paperclip::AdapterRegistry
  # @return [AdapterRegistry] a new instance of AdapterRegistry
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#7
  def initialize; end

  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#32
  def for(target, options = T.unsafe(nil)); end

  # @raise [NoHandlerError]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#19
  def handler_for(target); end

  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#11
  def register(handler_class, &block); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#26
  def registered?(target); end

  # Returns the value of attribute registered_handlers.
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#5
  def registered_handlers; end

  # source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#15
  def unregister(handler_class); end
end

# source://kt-paperclip//lib/paperclip/io_adapters/registry.rb#3
...
#
# source://kt-paperclip//lib/paperclip/attachment.rb#10
class Paperclip::Attachment
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#72
  def initialize(name, instance, options = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#187
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#99
  def assign(uploaded_file); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#363
  def blank?; end
  ...
  # use #destroy.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#248
  def clear(*styles_to_clear); end

  # Returns the content_type of the file as originally assigned, and lives
  # in the <attachment>_content_type attribute of the model.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#291
  def content_type; end

  # Returns the value of attribute convert_options.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#40
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#297
  def created_at; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#149
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#261
  def destroy; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#230
  def dirty?; end

  # Returns an array containing the errors on this attachment.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#225
  def errors; end
  ...
  # testing.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#159
  def expiring_url(_time = T.unsafe(nil), style_name = T.unsafe(nil)); end

  # Returns true if a file has been assigned.
  #
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#357
  def file?; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#285
  def fingerprint; end
  ...
  # @raise [ArgumentError]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#319
  ...
  # for more details.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#383
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#369
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#376
  ...
  # source://kt-paperclip//lib/paperclip/attachment.rb#208
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#273
  def original_filename; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#167
  def path(style_name = T.unsafe(nil)); end

  # Returns the value of attribute post_processing.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#42
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#361
  def present?; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#214
  def processors; end

  # Returns the value of attribute queued_for_delete.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#40
  def queued_for_delete; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#334
  def reprocess!(*style_args); end

  # Saves the file, if there are no errors. If there are, it flushes them to
  # the instance's errors and returns false, cancelling the save.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#236
  def save; end

  # Returns the size of the file as originally assigned, and lives in the
  # <attachment>_file_size attribute of the model.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#279
  def size; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#178
  def staged?; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#173
  def staged_path(style_name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#195
  def styles; end

  # The time zone to use for timestamp interpolation.  Using the default
  # time zone ensures that results are consistent across all threads.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#313
  def time_zone; end

  # Alias to +url+
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#183
  def to_s(style_name = T.unsafe(nil)); end

  # Returns the last modified time of the file as originally assigned, and
  # lives in the <attachment>_updated_at attribute of the model.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#306
  def updated_at; end

  # Returns the uploaded file if present.
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#267
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#141
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#608
  def able_to_store_created_at?; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#394
  def active_validator_classes; end

  # called by storage after the writes are flushed and before @queued_for_write is cleared
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#581
  def after_flush_writes; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#428
  def assign_attributes; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#435
  def assign_file_information; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#441
  def assign_fingerprint; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#445
  def assign_timestamps; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#503
  def check_validity?; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#603
  def cleanup_filename(filename); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#457
  def dirty!; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#406
  def ensure_required_accessors!; end

  # @raise [Paperclip::Errors::MissingRequiredValidatorError]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#402
  def ensure_required_validations!; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#475
  def extra_options_for(style); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#479
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#599
  def filename_cleaner; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#574
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#613
  def has_enabled_but_unset_created_at?; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#418
  def initialize_storage; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#548
  def interpolate(pattern, style_name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#414
  def log(message); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#398
  def missing_required_validator?; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#390
  def path_option; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#492
  def post_process(*style_args); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#451
  def post_process_file; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#517
  def post_process_style(name, style); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#508
  def post_process_styles(*style_args); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#483
  def process_options(options_type, style); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/attachment.rb#544
  def process_style?(style_name, style_args); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#558
  def queue_all_for_delete; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#552
  def queue_some_for_delete(*styles); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#461
  def reset_file_if_original_reprocessed; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#467
  def reset_updater; end

  # source://kt-paperclip//lib/paperclip/attachment.rb#585
  def unlink_files(files); end

  # source://kt-paperclip//lib/paperclip/attachment.rb#471
  def updater; end

  class << self
    # source://kt-paperclip//lib/paperclip/attachment.rb#11
    def default_options; end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/attachment_adapter.rb#2
class Paperclip::AttachmentAdapter < ::Paperclip::AbstractAdapter
  # @return [AttachmentAdapter] a new instance of AttachmentAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/attachment_adapter.rb#9
  def initialize(target, options = T.unsafe(nil)); end

  private

  # source://kt-paperclip//lib/paperclip/io_adapters/attachment_adapter.rb#23
  def cache_current_values; end

  # source://kt-paperclip//lib/paperclip/io_adapters/attachment_adapter.rb#30
  def copy_to_tempfile(source); end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/attachment_adapter.rb#3
    def register; end
  end
end

# source://kt-paperclip//lib/paperclip/attachment_registry.rb#4
class Paperclip::AttachmentRegistry
  ...
  #
  # source://kt-paperclip//lib/paperclip/attachment_registry.rb#27
  def initialize; end

  # source://kt-paperclip//lib/paperclip/attachment_registry.rb#37
  def clear; end

  # source://kt-paperclip//lib/paperclip/attachment_registry.rb#53
  def definitions_for(klass); end

  # source://kt-paperclip//lib/paperclip/attachment_registry.rb#45
  def each_definition; end

  # source://kt-paperclip//lib/paperclip/attachment_registry.rb#41
  def names_for(klass); end

  # source://kt-paperclip//lib/paperclip/attachment_registry.rb#31
  def register(klass, attachment_name, attachment_options); end

  class << self
    # source://kt-paperclip//lib/paperclip/attachment_registry.rb#11
    def clear; end

    # source://kt-paperclip//lib/paperclip/attachment_registry.rb#23
    def definitions_for(klass); end

    # source://kt-paperclip//lib/paperclip/attachment_registry.rb#19
    def each_definition(&block); end

    # source://kt-paperclip//lib/paperclip/attachment_registry.rb#15
    def names_for(klass); end

    # source://kt-paperclip//lib/paperclip/attachment_registry.rb#7
    def register(klass, attachment_name, attachment_options); end

    private

    # source://kt-paperclip//lib/paperclip/attachment_registry.rb#5
    def allocate; end
...
# source://kt-paperclip//lib/paperclip/callbacks.rb#2
module Paperclip::Callbacks
  ...
  class << self
    # @private
    #
    # source://kt-paperclip//lib/paperclip/callbacks.rb#3
    def included(base); end
  end
end

# source://kt-paperclip//lib/paperclip/callbacks.rb#8
module Paperclip::Callbacks::Defining
  # source://kt-paperclip//lib/paperclip/callbacks.rb#9
  def define_paperclip_callbacks(*callbacks); end

  private

  # source://kt-paperclip//lib/paperclip/callbacks.rb#25
  def hasta_la_vista_baby; end
end

# source://kt-paperclip//lib/paperclip/callbacks.rb#36
module Paperclip::Callbacks::Running
  # source://kt-paperclip//lib/paperclip/callbacks.rb#37
  def run_paperclip_callbacks(callback, &block); end
end

# source://kt-paperclip//lib/paperclip.rb#113
module Paperclip::ClassMethods
  ...
  #   end
  #
  # source://kt-paperclip//lib/paperclip.rb#197
  def has_attached_file(name, options = T.unsafe(nil)); end
end

# source://kt-paperclip//lib/paperclip/content_type_detector.rb#2
class Paperclip::ContentTypeDetector
  # @return [ContentTypeDetector] a new instance of ContentTypeDetector
  #
  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#23
  def initialize(filepath); end

  # Returns a String describing the file's content type
  #
  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#28
  def detect; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#42
  def blank_name?; end

  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#52
  def calculated_type_matches; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#50
  def empty?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#46
  def empty_file?; end

  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#58
  def possible_types; end

  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#80
  def type_from_file_command; end

  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#62
  def type_from_file_contents; end

  # source://kt-paperclip//lib/paperclip/content_type_detector.rb#69
  def type_from_marcel; end
end
...
#
# source://kt-paperclip//lib/paperclip/content_type_detector.rb#20
Paperclip::ContentTypeDetector::EMPTY_TYPE = T.let(T.unsafe(nil), String)

# source://kt-paperclip//lib/paperclip/content_type_detector.rb#21
Paperclip::ContentTypeDetector::SENSIBLE_DEFAULT = T.let(T.unsafe(nil), String)

# source://kt-paperclip//lib/paperclip/io_adapters/data_uri_adapter.rb#2
class Paperclip::DataUriAdapter < ::Paperclip::StringioAdapter
  # @return [DataUriAdapter] a new instance of DataUriAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/data_uri_adapter.rb#11
  def initialize(target_uri, options = T.unsafe(nil)); end

  private

  # source://kt-paperclip//lib/paperclip/io_adapters/data_uri_adapter.rb#17
  def extract_target(uri); end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/data_uri_adapter.rb#3
    def register; end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/data_uri_adapter.rb#9
Paperclip::DataUriAdapter::REGEXP = T.let(T.unsafe(nil), Regexp)

# source://kt-paperclip//lib/paperclip/io_adapters/empty_string_adapter.rb#2
class Paperclip::EmptyStringAdapter < ::Paperclip::AbstractAdapter
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/empty_string_adapter.rb#13
  def assignment?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/empty_string_adapter.rb#9
  def nil?; end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/empty_string_adapter.rb#3
    def register; end
  end
end
...
#
# source://kt-paperclip//lib/paperclip/errors.rb#4
class Paperclip::Error < ::StandardError; end

# source://kt-paperclip//lib/paperclip/errors.rb#7
module Paperclip::Errors; end

# Will be thrown when a command or executable is not found.
#
# source://kt-paperclip//lib/paperclip/errors.rb#13
...
#
# source://kt-paperclip//lib/paperclip/errors.rb#31
...
#
# source://kt-paperclip//lib/paperclip/errors.rb#18
...
#
# source://kt-paperclip//lib/paperclip/errors.rb#25
...
#
# source://kt-paperclip//lib/paperclip/errors.rb#9
class Paperclip::Errors::StorageMethodNotFound < ::Paperclip::Error; end

# source://kt-paperclip//lib/paperclip/io_adapters/file_adapter.rb#2
class Paperclip::FileAdapter < ::Paperclip::AbstractAdapter
  # @return [FileAdapter] a new instance of FileAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/file_adapter.rb#9
  def initialize(target, options = T.unsafe(nil)); end

  private

  # source://kt-paperclip//lib/paperclip/io_adapters/file_adapter.rb#16
  def cache_current_values; end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/file_adapter.rb#3
    def register; end
  end
end

# source://kt-paperclip//lib/paperclip/file_command_content_type_detector.rb#2
class Paperclip::FileCommandContentTypeDetector
  ...
  #
  # source://kt-paperclip//lib/paperclip/file_command_content_type_detector.rb#5
  def initialize(filename); end

  # source://kt-paperclip//lib/paperclip/file_command_content_type_detector.rb#9
  def detect; end

  private

  # source://kt-paperclip//lib/paperclip/file_command_content_type_detector.rb#15
  def type_from_file_command; end
end

# source://kt-paperclip//lib/paperclip/file_command_content_type_detector.rb#3
Paperclip::FileCommandContentTypeDetector::SENSIBLE_DEFAULT = T.let(T.unsafe(nil), String)

# source://kt-paperclip//lib/paperclip/filename_cleaner.rb#2
class Paperclip::FilenameCleaner
  # @return [FilenameCleaner] a new instance of FilenameCleaner
  #
  # source://kt-paperclip//lib/paperclip/filename_cleaner.rb#3
  def initialize(invalid_character_regex); end

  # source://kt-paperclip//lib/paperclip/filename_cleaner.rb#7
  def call(filename); end
end

# Defines the geometry of an image.
#
# source://kt-paperclip//lib/paperclip/geometry.rb#3
class Paperclip::Geometry
  # Gives a Geometry representing the given height and width
  #
  # @return [Geometry] a new instance of Geometry
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#9
  def initialize(width = T.unsafe(nil), height = T.unsafe(nil), modifier = T.unsafe(nil)); end

  # The aspect ratio of the dimensions.
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#59
  def aspect; end

  # Swaps the height and width if necessary
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#36
  def auto_orient; end

  # Returns the value of attribute height.
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#4
  def height; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#49
  def horizontal?; end

  # Same as to_s
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#83
  def inspect; end

  # Returns the larger of the two dimensions
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#64
  def larger; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#111
  def resize_to(geometry); end

  # Returns the smaller of the two dimensions
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#69
  def smaller; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#44
  def square?; end

  # Returns the width and height in a format suitable to be passed to Geometry.parse
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#74
  def to_s; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#94
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/geometry.rb#54
  def vertical?; end
  ...
  class << self
    ...
    #
    # source://kt-paperclip//lib/paperclip/geometry.rb#31
    def parse(string); end
  end
end

# source://kt-paperclip//lib/paperclip/geometry.rb#6
Paperclip::Geometry::EXIF_ROTATED_ORIENTATION_VALUES = T.let(T.unsafe(nil), Array)

# source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#2
class Paperclip::GeometryDetector
  # @return [GeometryDetector] a new instance of GeometryDetector
  #
  # source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#3
  def initialize(file); end

  # source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#8
  def make; end

  private

  # source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#15
  def geometry_string; end

  # source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#31
  def path; end

  # @raise [Errors::CommandNotFoundError]
  #
  # source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#41
  def raise_because_imagemagick_missing; end

  # source://kt-paperclip//lib/paperclip/geometry_detector_factory.rb#35
  def raise_if_blank_file; end
end

# source://kt-paperclip//lib/paperclip/geometry_parser_factory.rb#2
class Paperclip::GeometryParser
  # @return [GeometryParser] a new instance of GeometryParser
  #
  # source://kt-paperclip//lib/paperclip/geometry_parser_factory.rb#4
  def initialize(string); end

  # source://kt-paperclip//lib/paperclip/geometry_parser_factory.rb#8
  def make; end

  private

  # source://kt-paperclip//lib/paperclip/geometry_parser_factory.rb#21
  def match; end
end

# source://kt-paperclip//lib/paperclip/geometry_parser_factory.rb#3
Paperclip::GeometryParser::FORMAT = T.let(T.unsafe(nil), Regexp)

# source://kt-paperclip//lib/paperclip/glue.rb#6
module Paperclip::Glue
  ...
  class << self
    # @private
    #
    # source://kt-paperclip//lib/paperclip/glue.rb#9
    def included(base); end
  end
end

# source://kt-paperclip//lib/paperclip/glue.rb#7
Paperclip::Glue::LOCALE_PATHS = T.let(T.unsafe(nil), Array)

# source://kt-paperclip//lib/paperclip/has_attached_file.rb#2
class Paperclip::HasAttachedFile
  # @return [HasAttachedFile] a new instance of HasAttachedFile
  #
  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#7
  def initialize(klass, name, options); end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#13
  def define; end

  private

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#90
  def add_active_record_callbacks; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#103
  def add_paperclip_callbacks; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#81
  def add_required_validations; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#59
  def define_class_getter; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#26
  def define_flush_errors; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#33
  def define_getters; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#38
  def define_instance_getter; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#70
  def define_query; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#63
  def define_setter; end

  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#77
  def register_new_attachment; end

  class << self
    # source://kt-paperclip//lib/paperclip/has_attached_file.rb#3
    def define_on(klass, name, options); end
  end
end

# source://kt-paperclip//lib/paperclip/has_attached_file.rb#110
module Paperclip::HasAttachedFile::ClassMethods
  # source://kt-paperclip//lib/paperclip/has_attached_file.rb#111
  def attachment_definitions; end
end

# source://kt-paperclip//lib/paperclip/helpers.rb#2
module Paperclip::Helpers
  # source://kt-paperclip//lib/paperclip/helpers.rb#46
  def class_for(class_name); end

  # @yield [_self]
  # @yieldparam _self [Paperclip::Helpers] the object that the method was called on
  #
  # source://kt-paperclip//lib/paperclip/helpers.rb#3
  def configure; end

  # Find all instances of the given Active Record model +klass+ with attachment +name+.
  # This method is used by the refresh rake tasks.
  #
  # source://kt-paperclip//lib/paperclip/helpers.rb#40
  def each_instance_with_attachment(klass, name); end

  # source://kt-paperclip//lib/paperclip/helpers.rb#7
  def interpolates(key, &block); end

  # source://kt-paperclip//lib/paperclip/helpers.rb#56
  ...
  #                                    runner_options
  #
  # source://kt-paperclip//lib/paperclip/helpers.rb#28
  def run(cmd, arguments = T.unsafe(nil), interpolation_values = T.unsafe(nil), local_options = T.unsafe(nil)); end
end

# source://kt-paperclip//lib/paperclip/io_adapters/http_url_proxy_adapter.rb#2
class Paperclip::HttpUrlProxyAdapter < ::Paperclip::UriAdapter
  # @return [HttpUrlProxyAdapter] a new instance of HttpUrlProxyAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/http_url_proxy_adapter.rb#11
  def initialize(target, options = T.unsafe(nil)); end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/http_url_proxy_adapter.rb#3
    def register; end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/http_url_proxy_adapter.rb#9
Paperclip::HttpUrlProxyAdapter::REGEXP = T.let(T.unsafe(nil), Regexp)

# source://kt-paperclip//lib/paperclip/io_adapters/identity_adapter.rb#2
class Paperclip::IdentityAdapter < ::Paperclip::AbstractAdapter
  # @return [IdentityAdapter] a new instance of IdentityAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/identity_adapter.rb#9
  def initialize; end

  # source://kt-paperclip//lib/paperclip/io_adapters/identity_adapter.rb#11
  def new(target, _); end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/identity_adapter.rb#3
    def register; end
  end
end
...
#
# source://kt-paperclip//lib/paperclip/interpolations/plural_cache.rb#2
module Paperclip::Interpolations
  ...
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#196
  def attachment(attachment, _style_name); end

  # Returns the basename of the file. e.g. "file" for "file.jpg"
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#103
  def basename(attachment, _style_name); end
  ...
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#96
  ...
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#130
  ...
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#118
  ...
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#110
  def extension(attachment, style_name); end

  # Returns the filename, the same way as ":basename.:extension" would.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#50
  def filename(attachment, style_name); end

  # Returns the fingerprint of the instance.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#165
  def fingerprint(attachment, _style_name); end

  # Returns a the attachment hash.  See Paperclip::Attachment#hash_key for
  # more details.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#171
  def hash(attachment = T.unsafe(nil), style_name = T.unsafe(nil)); end

  # Returns the id of the instance.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#155
  def id(attachment, _style_name); end

  # Returns the id of the instance in a split path form. e.g. returns
  # 000/001/234 for an id of 1234.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#181
  def id_partition(attachment, _style_name); end

  # Returns the #to_param of the instance.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#160
  def param(attachment, _style_name); end

  # Returns the Rails.env constant.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#88
  def rails_env(_attachment, _style_name); end

  # Returns the Rails.root constant.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#83
  def rails_root(_attachment, _style_name); end

  # Returns the style, or the default style if nil is supplied.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#201
  ...
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#72
  def timestamp(attachment, _style_name); end

  # Returns an integer timestamp that is time zone-neutral, so that paths
  # remain valid even if a server's time zone changes.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#78
  def updated_at(attachment, _style_name); end

  # Returns the interpolated URL. Will raise an error if the url itself
  # contains ":url" to prevent infinite recursion. This interpolation
  # is used in the default :path to ease default specifications.
  #
  # source://kt-paperclip//lib/paperclip/interpolations.rb#57
  ...
  class << self
    ...
    #
    # source://kt-paperclip//lib/paperclip/interpolations.rb#19
    def [](name); end

    # Hash assignment of interpolations. Included only for compatibility,
    # and is not intended for normal use.
    #
    # source://kt-paperclip//lib/paperclip/interpolations.rb#12
    def []=(name, block); end

    # Returns a sorted list of all interpolations.
    #
    # source://kt-paperclip//lib/paperclip/interpolations.rb#24
    def all; end
    ...
    #
    # source://kt-paperclip//lib/paperclip/interpolations.rb#32
    def interpolate(pattern, *args); end

    # source://kt-paperclip//lib/paperclip/interpolations.rb#41
    def interpolators_cache; end

    # source://kt-paperclip//lib/paperclip/interpolations.rb#45
    def plural_cache; end
  end
end

# source://kt-paperclip//lib/paperclip/interpolations.rb#8
Paperclip::Interpolations::ID_PARTITION_LIMIT = T.let(T.unsafe(nil), Integer)

# source://kt-paperclip//lib/paperclip/interpolations/plural_cache.rb#3
class Paperclip::Interpolations::PluralCache
  # @return [PluralCache] a new instance of PluralCache
  #
  # source://kt-paperclip//lib/paperclip/interpolations/plural_cache.rb#4
  def initialize; end

  # source://kt-paperclip//lib/paperclip/interpolations/plural_cache.rb#9
  def pluralize_symbol(symbol); end

  # source://kt-paperclip//lib/paperclip/interpolations/plural_cache.rb#13
  def underscore_and_pluralize_class(klass); end
end

# source://kt-paperclip//lib/paperclip/logger.rb#2
module Paperclip::Logger
  # Log a paperclip-specific line. This will log to STDOUT
  # by default. Set Paperclip.options[:log] to false to turn off.
  #
  # source://kt-paperclip//lib/paperclip/logger.rb#5
  def log(message); end

  # source://kt-paperclip//lib/paperclip/logger.rb#9
  def logger; end

  # source://kt-paperclip//lib/paperclip/logger.rb#13
  def logger=(logger); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/logger.rb#17
  def logging?; end
end

# source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#2
class Paperclip::MediaTypeSpoofDetector
  # @return [MediaTypeSpoofDetector] a new instance of MediaTypeSpoofDetector
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#7
  def initialize(file, name, content_type); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#13
  def spoofed?; end

  private

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#67
  def calculated_content_type; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#71
  def calculated_media_type; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#42
  def calculated_type_mismatch?; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#59
  def content_types_from_name; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#36
  def extension_type_mismatch?; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#89
  def filename_extension; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#28
  def has_extension?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#24
  def has_name?; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#84
  def mapped_content_type; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#47
  def mapping_override_mismatch?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#32
  def media_type_mismatch?; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#63
  def media_types_from_name; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#51
  def supplied_content_type; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#55
  def supplied_media_type; end

  # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#75
  def type_from_file_command; end

  class << self
    # source://kt-paperclip//lib/paperclip/media_type_spoof_detector.rb#3
    def using(file, name, content_type); end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#2
class Paperclip::NilAdapter < ::Paperclip::AbstractAdapter
  # @return [NilAdapter] a new instance of NilAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#9
  def initialize(_target, _options = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#15
  def content_type; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#31
  def eof?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#23
  def nil?; end

  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#11
  def original_filename; end

  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#27
  def read(*_args); end

  # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#19
  def size; end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/nil_adapter.rb#3
    def register; end
  end
end
...
#
# source://kt-paperclip//lib/paperclip/processor.rb#21
class Paperclip::Processor
  # @return [Processor] a new instance of Processor
  #
  # source://kt-paperclip//lib/paperclip/processor.rb#24
  def initialize(file, options = T.unsafe(nil), attachment = T.unsafe(nil)); end

  # Returns the value of attribute attachment.
  #
  # source://kt-paperclip//lib/paperclip/processor.rb#22
  def attachment; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/processor.rb#38
  ...
  # See Paperclip.run for the available options.
  #
  # source://kt-paperclip//lib/paperclip/processor.rb#48
  def identify(arguments = T.unsafe(nil), local_options = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/processor.rb#30
  def make; end
  ...
  class << self
    # source://kt-paperclip//lib/paperclip/processor.rb#32
    def make(file, options = T.unsafe(nil), attachment = T.unsafe(nil)); end
  end
end

# source://kt-paperclip//lib/paperclip/processor_helpers.rb#2
module Paperclip::ProcessorHelpers
  # source://kt-paperclip//lib/paperclip/processor_helpers.rb#35
  def clear_processors!; end

  # source://kt-paperclip//lib/paperclip/processor_helpers.rb#17
  def load_processor(name); end

  # source://kt-paperclip//lib/paperclip/processor_helpers.rb#5
  ...
  #   end
  #
  # source://kt-paperclip//lib/paperclip/processor_helpers.rb#47
  def register_processor(name, processor); end
end

# source://kt-paperclip//lib/paperclip/processor_helpers.rb#3
class Paperclip::ProcessorHelpers::NoSuchProcessor < ::StandardError; end

# source://kt-paperclip//lib/paperclip/validators.rb#20
Paperclip::REQUIRED_VALIDATORS = T.let(T.unsafe(nil), Array)

# source://kt-paperclip//lib/paperclip/rails_environment.rb#2
class Paperclip::RailsEnvironment
  # source://kt-paperclip//lib/paperclip/rails_environment.rb#7
  def get; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/rails_environment.rb#17
  def rails_environment_exists?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/rails_environment.rb#13
  def rails_exists?; end

  class << self
    # source://kt-paperclip//lib/paperclip/rails_environment.rb#3
    def get; end
  end
end

# source://kt-paperclip//lib/paperclip/railtie.rb#7
class Paperclip::Railtie < ::Rails::Railtie
  class << self
    # source://kt-paperclip//lib/paperclip/railtie.rb#22
    def insert; end
  end
end
...
#
# source://kt-paperclip//lib/paperclip/schema.rb#5
module Paperclip::Schema
  class << self
    # @private
    #
    # source://kt-paperclip//lib/paperclip/schema.rb#11
    def included(_base); end
  end
end

# source://kt-paperclip//lib/paperclip/schema.rb#6
Paperclip::Schema::COLUMNS = T.let(T.unsafe(nil), Hash)

# source://kt-paperclip//lib/paperclip/schema.rb#69
module Paperclip::Schema::CommandRecorder
  # source://kt-paperclip//lib/paperclip/schema.rb#70
  def add_attachment(*args); end

  private

  # source://kt-paperclip//lib/paperclip/schema.rb#76
  def invert_add_attachment(args); end
end

# source://kt-paperclip//lib/paperclip/schema.rb#18
module Paperclip::Schema::Statements
  # source://kt-paperclip//lib/paperclip/schema.rb#19
  def add_attachment(table_name, *attachment_names); end

  # source://kt-paperclip//lib/paperclip/schema.rb#46
  def drop_attached_file(*args); end

  # source://kt-paperclip//lib/paperclip/schema.rb#34
  def remove_attachment(table_name, *attachment_names); end
end

# source://kt-paperclip//lib/paperclip/schema.rb#52
module Paperclip::Schema::TableDefinition
  # source://kt-paperclip//lib/paperclip/schema.rb#53
  def attachment(*attachment_names); end

  # source://kt-paperclip//lib/paperclip/schema.rb#63
  def has_attached_file(*attachment_names); end
end

# source://kt-paperclip//lib/paperclip/storage/filesystem.rb#2
...
#
# source://kt-paperclip//lib/paperclip/storage/filesystem.rb#24
module Paperclip::Storage::Filesystem
  # source://kt-paperclip//lib/paperclip/storage/filesystem.rb#83
  def copy_to_local_file(style, local_dest_path); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/storage/filesystem.rb#27
  def exists?(style_name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/filesystem.rb#59
  def flush_deletes; end

  # source://kt-paperclip//lib/paperclip/storage/filesystem.rb#35
  def flush_writes; end

  private

  # source://kt-paperclip//lib/paperclip/storage/filesystem.rb#89
  def move_file(src, dest); end

  class << self
    # @private
    #
    # source://kt-paperclip//lib/paperclip/storage/filesystem.rb#25
...
#
# source://kt-paperclip//lib/paperclip/storage/fog.rb#41
module Paperclip::Storage::Fog
  # source://kt-paperclip//lib/paperclip/storage/fog.rb#178
  def copy_to_local_file(style, local_dest_path); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/storage/fog.rb#67
  def exists?(style = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#157
  def expiring_url(time = T.unsafe(nil), style_name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#137
  def flush_deletes; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#107
  def flush_writes; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#75
  def fog_credentials; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#79
  def fog_file; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#92
  def fog_public(style = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#173
  def parse_credentials(creds); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#145
  def public_url(style = T.unsafe(nil)); end

  private

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#231
  def connection; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#193
  def convert_time(time); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#235
  def directory; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#239
  def directory_name; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#198
  def dynamic_fog_host_for_style(style); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#214
  def find_credentials(creds); end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#206
  def host_name_for_directory; end

  # source://kt-paperclip//lib/paperclip/storage/fog.rb#247
  def scheme; end

  class << self
    # @private
    #
    # source://kt-paperclip//lib/paperclip/storage/fog.rb#42
    def extended(base); end
  end
end

# source://kt-paperclip//lib/paperclip/storage/fog.rb#65
...
#
# source://kt-paperclip//lib/paperclip/storage/s3.rb#123
module Paperclip::Storage::S3
  # source://kt-paperclip//lib/paperclip/storage/s3.rb#234
  def bucket_name; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#423
  def copy_to_local_file(style, local_dest_path); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#354
  def create_bucket; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/storage/s3.rb#323
  def exists?(style = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#188
  def expiring_url(time = T.unsafe(nil), style_name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#411
  def flush_deletes; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#358
  def flush_writes; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#291
  def http_proxy_host; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#303
  def http_proxy_password; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#295
  def http_proxy_port; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#299
  def http_proxy_user; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#266
  def obtain_s3_instance_for(options); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#317
  def parse_credentials(creds); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#271
  def s3_bucket; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#200
  def s3_credentials; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#218
  def s3_host_alias; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#204
  def s3_host_name; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#240
  def s3_interface; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#279
  def s3_object(style_name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#333
  def s3_permissions(style = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#224
  def s3_prefixes_in_alias; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#343
  def s3_protocol(style = T.unsafe(nil), with_colon = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#211
  def s3_region; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#339
  def s3_storage_class(style = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#228
  def s3_url_options; end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#307
  def set_permissions(permissions); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#312
  def set_storage_class(storage_class); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#275
  def style_name_as_path(style_name); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/storage/s3.rb#283
  def use_accelerate_endpoint?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/storage/s3.rb#287
  def using_http_proxy?; end

  private

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#433
  def find_credentials(creds); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#448
  def load_credentials_from_file(path); end

  # source://kt-paperclip//lib/paperclip/storage/s3.rb#460
  def merge_s3_headers(http_headers, s3_headers, s3_metadata); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/storage/s3.rb#456
  def use_secure_protocol?(style_name); end

  class << self
    # @private
    #
    # source://kt-paperclip//lib/paperclip/storage/s3.rb#124
    def extended(base); end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/stringio_adapter.rb#2
class Paperclip::StringioAdapter < ::Paperclip::AbstractAdapter
  # @return [StringioAdapter] a new instance of StringioAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/stringio_adapter.rb#9
  def initialize(target, options = T.unsafe(nil)); end
  ...
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/stringio_adapter.rb#14
  def content_type=(_arg0); end

  private

  # source://kt-paperclip//lib/paperclip/io_adapters/stringio_adapter.rb#18
  def cache_current_values; end

  # source://kt-paperclip//lib/paperclip/io_adapters/stringio_adapter.rb#26
  def copy_to_tempfile(source); end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/stringio_adapter.rb#3
    def register; end
  end
end
...
#
# source://kt-paperclip//lib/paperclip/style.rb#6
class Paperclip::Style
  ...
  #
  # source://kt-paperclip//lib/paperclip/style.rb#12
  def initialize(name, definition, attachment); end

  # Supports getting and setting style properties with hash notation to ensure backwards-compatibility
  # eg. @attachment.styles[:large][:geometry]@ will still work
  #
  # source://kt-paperclip//lib/paperclip/style.rb#84
  def [](key); end

  # source://kt-paperclip//lib/paperclip/style.rb#92
  def []=(key, value); end

  # Returns the value of attribute attachment.
  #
  # source://kt-paperclip//lib/paperclip/style.rb#7
  def attachment; end

  # source://kt-paperclip//lib/paperclip/style.rb#52
  def convert_options; end

  # defaults to default format (nil by default)
  #
  # source://kt-paperclip//lib/paperclip/style.rb#101
  ...
  #
  # source://kt-paperclip//lib/paperclip/style.rb#64
  def geometry; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/style.rb#71
  ...
  # if a proc has been supplied, we call it here
  #
  # source://kt-paperclip//lib/paperclip/style.rb#38
  def processors; end

  # source://kt-paperclip//lib/paperclip/style.rb#57
  def source_file_options; end

  # retrieves from the attachment the whiny setting
  #
  # source://kt-paperclip//lib/paperclip/style.rb#43
  def whiny; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/style.rb#48
  def whiny?; end
end

# Overriding some implementation of Tempfile
#
# source://kt-paperclip//lib/paperclip/tempfile.rb#3
class Paperclip::Tempfile < ::Tempfile
  ...
  #
  # source://kt-paperclip//lib/paperclip/tempfile.rb#11
  def make_tmpname(prefix_suffix, n); end
end

# source://kt-paperclip//lib/paperclip/tempfile.rb#31
module Paperclip::TempfileEncoding
  ...
  # in JRuby
  #
  # source://kt-paperclip//lib/paperclip/tempfile.rb#35
  def binmode; end
end

# source://kt-paperclip//lib/paperclip/tempfile_factory.rb#2
class Paperclip::TempfileFactory
  # source://kt-paperclip//lib/paperclip/tempfile_factory.rb#14
  def basename; end

  # source://kt-paperclip//lib/paperclip/tempfile_factory.rb#10
  def extension; end

  # source://kt-paperclip//lib/paperclip/tempfile_factory.rb#3
  def generate(name = T.unsafe(nil)); end

  # source://kt-paperclip//lib/paperclip/tempfile_factory.rb#18
  def random_name; end
end

# Handles thumbnailing images that are uploaded.
#
# source://kt-paperclip//lib/paperclip/thumbnail.rb#3
class Paperclip::Thumbnail < ::Paperclip::Processor
  ...
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#29
  def initialize(file, options = T.unsafe(nil), attachment = T.unsafe(nil)); end

  # Returns the value of attribute animated.
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#4
  def animated; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#57
  def convert_options?; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#52
  def crop?; end
  ...
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#63
  def make; end
  ...
  # into the thumbnail.
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#98
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#115
  def animated?; end
  ...
  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#120
  def identified_as_animated?; end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/thumbnail.rb#111
  def multi_frame_format?; end
end

# List of formats that we need to preserve animation
#
# source://kt-paperclip//lib/paperclip/thumbnail.rb#8
Paperclip::Thumbnail::ANIMATED_FORMATS = T.let(T.unsafe(nil), Array)

# source://kt-paperclip//lib/paperclip/thumbnail.rb#9
Paperclip::Thumbnail::MULTI_FRAME_FORMATS = T.let(T.unsafe(nil), Array)

# source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#2
class Paperclip::UploadedFileAdapter < ::Paperclip::AbstractAdapter
  ...
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#9
  def initialize(target, options = T.unsafe(nil)); end

  private

  # source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#26
  def cache_current_values; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#32
  def content_type_detector; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#36
  def determine_content_type; end

  class << self
    # Returns the value of attribute content_type_detector.
    #
    # source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#21
    def content_type_detector; end
    ...
    # source://kt-paperclip//lib/paperclip/io_adapters/uploaded_file_adapter.rb#3
    def register; end
  end
end

# source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#4
class Paperclip::UriAdapter < ::Paperclip::AbstractAdapter
  # @return [UriAdapter] a new instance of UriAdapter
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#13
  def initialize(target, options = T.unsafe(nil)); end
  ...
  # @param value the value to set the attribute content_type to.
  #
  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#5
  def content_type=(_arg0); end

  private

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#22
  def cache_current_values; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#30
  def content_type_from_content; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#69
  def copy_to_tempfile(src); end

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#49
  def default_filename; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#62
  def download_content; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#34
  def filename_from_content_disposition; end

  # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#45
  def filename_from_path; end

  class << self
    # source://kt-paperclip//lib/paperclip/io_adapters/uri_adapter.rb#7
    def register; end
  end
end

# source://kt-paperclip//lib/paperclip/url_generator.rb#5
class Paperclip::UrlGenerator
  # @return [UrlGenerator] a new instance of UrlGenerator
  #
  # source://kt-paperclip//lib/paperclip/url_generator.rb#13
  def initialize(attachment); end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#29
  def attachment_options(*_arg0, **_arg1, &_arg2); end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#17
  ...
  # Returns the value of attribute attachment.
  #
  # source://kt-paperclip//lib/paperclip/url_generator.rb#28
  def attachment; end

  # This method is all over the place.
  #
  # source://kt-paperclip//lib/paperclip/url_generator.rb#32
  def default_url; end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#79
  def escape_regex; end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#71
  def escape_url(url); end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#63
  def escape_url_as_needed(url, options); end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#42
  def most_appropriate_url; end

  # source://kt-paperclip//lib/paperclip/url_generator.rb#50
  def timestamp_as_needed(url, options); end

  # @return [Boolean]
  #
  # source://kt-paperclip//lib/paperclip/url_generator.rb#59
  def timestamp_possible?; end

  class << self
    # source://kt-paperclip//lib/paperclip/url_generator.rb#7
    def encoder; end

    # source://kt-paperclip//lib/paperclip/url_generator.rb#10
...
# source://kt-paperclip//lib/paperclip/version.rb#2
Paperclip::VERSION = T.let(T.unsafe(nil), String)

# source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#2
...
# source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#3
class Paperclip::Validators::AttachmentContentTypeValidator < ::ActiveModel::EachValidator
  ...
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#4
  def initialize(options); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#53
  def allowed_types; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#61
  def check_validity!; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#57
  def forbidden_types; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#49
  def mark_invalid(record, attribute, types); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#43
  def validate_blacklist(record, attribute, value); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#16
  def validate_each(record, attribute, value); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#37
  def validate_whitelist(record, attribute, value); end

  class << self
    # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#12
    def helper_method_name; end
  end
end

# source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#3
class Paperclip::Validators::AttachmentFileNameValidator < ::ActiveModel::EachValidator
  ...
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#4
  def initialize(options); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#49
  def allowed; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#57
  def check_validity!; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#53
  def forbidden; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#45
  def mark_invalid(record, attribute, patterns); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#41
  def validate_blacklist(record, attribute, value); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#16
  def validate_each(record, attribute, value); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#37
  def validate_whitelist(record, attribute, value); end

  class << self
    # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#12
    def helper_method_name; end
  end
end

# source://kt-paperclip//lib/paperclip/validators/attachment_file_type_ignorance_validator.rb#5
class Paperclip::Validators::AttachmentFileTypeIgnoranceValidator < ::ActiveModel::EachValidator
  # source://kt-paperclip//lib/paperclip/validators/attachment_file_type_ignorance_validator.rb#6
  def validate_each(record, attribute, value); end

  class << self
    # source://kt-paperclip//lib/paperclip/validators/attachment_file_type_ignorance_validator.rb#11
    def helper_method_name; end
  end
end

# source://kt-paperclip//lib/paperclip/validators/attachment_presence_validator.rb#5
class Paperclip::Validators::AttachmentPresenceValidator < ::ActiveModel::EachValidator
  # source://kt-paperclip//lib/paperclip/validators/attachment_presence_validator.rb#6
  def validate_each(record, attribute, _value); end

  class << self
    # source://kt-paperclip//lib/paperclip/validators/attachment_presence_validator.rb#10
    def helper_method_name; end
  end
end

# source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#5
class Paperclip::Validators::AttachmentSizeValidator < ::ActiveModel::Validations::NumericalityValidator
  ...
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#8
  def initialize(options); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#54
  def check_validity!; end

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#17
  def validate_each(record, attr_name, value); end

  private

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#78
  def extract_option_value(option, option_value); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#62
  def extract_options(options); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#90
  def human_size(size); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#101
  def max_value_in_human_size(record); end

  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#94
  def min_value_in_human_size(record); end

  class << self
    # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#13
    def helper_method_name; end
  end
end

# source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#6
Paperclip::Validators::AttachmentSizeValidator::AVAILABLE_CHECKS = T.let(T.unsafe(nil), Array)

# source://kt-paperclip//lib/paperclip/validators.rb#22
module Paperclip::Validators::ClassMethods
  # source://kt-paperclip//lib/paperclip/validators.rb#64
  def create_validating_before_filter(attribute, validator_class, options); end

  # source://kt-paperclip//lib/paperclip/validators.rb#55
  ...
  #
  # source://kt-paperclip//lib/paperclip/validators.rb#35
  def validates_attachment(*attributes); end
end

# source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#68
module Paperclip::Validators::HelperMethods
  ...
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_file_type_ignorance_validator.rb#22
  ...
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_content_type_validator.rb#88
  ...
  # * +unless+: Same as +if+ but validates if lambda or method returns false.
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_file_name_validator.rb#75
  ...
  # * +unless+: Same as +if+ but validates if lambda or method returns false.
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_presence_validator.rb#21
  ...
  # * +unless+: Same as +if+ but validates if lambda or method returns false.
  #
  # source://kt-paperclip//lib/paperclip/validators/attachment_size_validator.rb#119
  ...
  # * +unless+: Same as +if+ but validates if lambda or method returns false.
  #
  # source://kt-paperclip//lib/paperclip/validators/media_type_spoof_detection_validator.rb#22
  def validates_media_type_spoof_detection(*attr_names); end
end

# source://kt-paperclip//lib/paperclip/validators/media_type_spoof_detection_validator.rb#5
class Paperclip::Validators::MediaTypeSpoofDetectionValidator < ::ActiveModel::EachValidator
  # source://kt-paperclip//lib/paperclip/validators/media_type_spoof_detection_validator.rb#6
  def validate_each(record, attribute, value); end
end
