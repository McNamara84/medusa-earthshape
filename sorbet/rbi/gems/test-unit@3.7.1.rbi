...
#   end
#
# source://test-unit//lib/test/unit/assertions.rb#46
module Test::Unit::Assertions
  ...
  # @return [void]
  #
  # source://test-unit//lib/test/unit/assertions.rb#1936
  def add_assertion; end

  # @overload assert
  # @overload assert
  #
  # source://test-unit//lib/test/unit/assertions.rb#137
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1590
  def assert_alias_method(object, alias_name, original_name, message = T.unsafe(nil)); end

  # @overload assert_all
  # @since 3.4.4
  #
  # source://test-unit//lib/test/unit/assertions.rb#1800
  ...
  # @since 3.4.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#1826
  def assert_all?(collection, message = T.unsafe(nil)); end
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#56
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1361
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1410
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1505
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1735
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#228
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1443
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1393
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#930
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1092
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1674
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#1691
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#394
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#481
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#604
  ...
  #   assert_nil [1, 2].uniq!
  #
  # source://test-unit//lib/test/unit/assertions.rb#465
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#801
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1522
  ...
  #   assert_not_empty({})                       # -> fail
  #
  # source://test-unit//lib/test/unit/assertions.rb#1758
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#743
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#974
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1153
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1701
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1718
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#430
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#519
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#778
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#760
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#661
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1561
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#577
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#723
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1326
  def assert_not_send(send_array, message = T.unsafe(nil)); end

  # @overload assert_nothing_leaked_memory
  # @since 3.4.5
  #
  # source://test-unit//lib/test/unit/assertions.rb#1874
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#686
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#906
  ...
  #   assert_operator 5, :>=, 4
  #
  # source://test-unit//lib/test/unit/assertions.rb#638
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1637
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1655
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1539
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#272
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#369
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1467
  ...
  # @since 3.4.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#321
  ...
  #   assert_raise(RuntimeError.new("ZZZ")) {raise "XXX"} # -> fail
  #
  # source://test-unit//lib/test/unit/assertions.rb#294
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#554
  ...
  #   assert_same o, o
  #
  # source://test-unit//lib/test/unit/assertions.rb#621
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1286
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#860
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#897
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1377
  ...
  # the template.
  #
  # source://test-unit//lib/test/unit/assertions.rb#1907
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#714
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#194
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1774
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#753
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1723
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#458
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#547
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#791
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#770
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#677
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1580
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#597
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#736
  def refute_same(expected, actual, message = T.unsafe(nil)); end

  private

  # source://test-unit//lib/test/unit/assertions.rb#1031
  ...
  # source://test-unit//lib/test/unit/assertions.rb#1015
  def _assert_in_delta_validate_arguments(expected_float, actual_float, delta); end

  # source://test-unit//lib/test/unit/assertions.rb#1219
  ...
  # source://test-unit//lib/test/unit/assertions.rb#1203
  def _assert_in_epsilon_validate_arguments(expected_float, actual_float, epsilon); end

  # source://test-unit//lib/test/unit/assertions.rb#1947
  def _assert_raise(assert_expected_exception, *args, &block); end

  # source://test-unit//lib/test/unit/assertions.rb#1976
  def _set_failed_information(failure, expected, actual); end

  # source://test-unit//lib/test/unit/assertions.rb#1913
  ...
  class << self
    ...
    #
    # source://test-unit//lib/test/unit/assertions.rb#1942
...
class Test::Unit::Assertions::AssertExceptionHelper
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2435
  def initialize(test_case, expected_exceptions); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2457
  def expected?(actual_exception, equality = T.unsafe(nil)); end

  # source://test-unit//lib/test/unit/assertions.rb#2442
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2501
  def exception_class?(exception_type); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2491
  def exception_object?(exception_type); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2511
  def expected_class?(actual_exception, equality); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2517
  def expected_module?(actual_exception); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2523
  def expected_object?(actual_exception); end

  # source://test-unit//lib/test/unit/assertions.rb#2530
  def fallback_exception_object_equal(expected_object, actual_exception); end

  # source://test-unit//lib/test/unit/assertions.rb#2465
...
# source://test-unit//lib/test/unit/assertions.rb#2397
class Test::Unit::Assertions::AssertExceptionHelper::WrappedException
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2399
  def initialize(exception); end

  # Returns the value of attribute exception.
  #
  # source://test-unit//lib/test/unit/assertions.rb#2398
  def exception; end

  # source://test-unit//lib/test/unit/assertions.rb#2403
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2418
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2423
...
class Test::Unit::Assertions::AssertionMessage
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2358
  def initialize(user_message, template_string, parameters); end

  # source://test-unit//lib/test/unit/assertions.rb#2364
  def convert(object); end

  # source://test-unit//lib/test/unit/assertions.rb#2368
  def template; end

  # source://test-unit//lib/test/unit/assertions.rb#2379
  def to_s; end

  # source://test-unit//lib/test/unit/assertions.rb#2372
  def user_message; end

  private

  # source://test-unit//lib/test/unit/assertions.rb#2391
  def add_period(string); end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2074
    def convert(object); end

    # source://test-unit//lib/test/unit/assertions.rb#2051
    def delayed_diff(from, to); end

    # source://test-unit//lib/test/unit/assertions.rb#1992
    def delayed_literal(&block); end

    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2020
    def diff_target_string?(string); end

    # source://test-unit//lib/test/unit/assertions.rb#2028
    def ensure_diffable_string(string); end

    # source://test-unit//lib/test/unit/assertions.rb#1988
    def literal(value); end

    # source://test-unit//lib/test/unit/assertions.rb#2001
    def max_diff_target_string_size; end

    # source://test-unit//lib/test/unit/assertions.rb#2016
    def max_diff_target_string_size=(size); end

    # source://test-unit//lib/test/unit/assertions.rb#1996
    def maybe_container(value, &formatter); end

    # source://test-unit//lib/test/unit/assertions.rb#2036
    def prepare_for_diff(from, to); end

    # Returns the value of attribute use_pp.
    #
    # source://test-unit//lib/test/unit/assertions.rb#1986
    def use_pp; end
...
# source://test-unit//lib/test/unit/assertions.rb#2238
class Test::Unit::Assertions::AssertionMessage::ArrayInspector
  # @return [ArrayInspector] a new instance of ArrayInspector
  #
  # source://test-unit//lib/test/unit/assertions.rb#2247
  def initialize(array, inspected_objects); end

  # source://test-unit//lib/test/unit/assertions.rb#2270
  def each(&block); end

  # source://test-unit//lib/test/unit/assertions.rb#2254
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2258
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2266
  def pretty_print_cycle(q); end

  class << self
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2242
...
# source://test-unit//lib/test/unit/assertions.rb#2285
class Test::Unit::Assertions::AssertionMessage::DelayedLiteral
  # @return [DelayedLiteral] a new instance of DelayedLiteral
  #
  # source://test-unit//lib/test/unit/assertions.rb#2286
  def initialize(value); end

  # source://test-unit//lib/test/unit/assertions.rb#2290
  def inspect; end
...
# source://test-unit//lib/test/unit/assertions.rb#2184
class Test::Unit::Assertions::AssertionMessage::HashInspector
  # @return [HashInspector] a new instance of HashInspector
  #
  # source://test-unit//lib/test/unit/assertions.rb#2193
  def initialize(hash, inspected_objects); end

  # source://test-unit//lib/test/unit/assertions.rb#2226
  def each_pair; end

  # source://test-unit//lib/test/unit/assertions.rb#2203
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2207
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2222
  def pretty_print_cycle(q); end

  class << self
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2188
    def target?(object); end
...
# source://test-unit//lib/test/unit/assertions.rb#2094
class Test::Unit::Assertions::AssertionMessage::Inspector
  include ::Comparable

  # @return [Inspector] a new instance of Inspector
  #
  # source://test-unit//lib/test/unit/assertions.rb#2118
  def initialize(object, inspected_objects = T.unsafe(nil)); end

  # source://test-unit//lib/test/unit/assertions.rb#2138
  def <=>(other); end

  # source://test-unit//lib/test/unit/assertions.rb#2126
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2125
  def native_inspect; end

  # Returns the value of attribute object.
  #
  # source://test-unit//lib/test/unit/assertions.rb#2117
  def object; end

  # source://test-unit//lib/test/unit/assertions.rb#2130
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2134
  def pretty_print_cycle(q); end

  private

  # source://test-unit//lib/test/unit/assertions.rb#2147
  def inspect_target; end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2098
    def cached_new(object, inspected_objects); end

    # source://test-unit//lib/test/unit/assertions.rb#2104
    def inspector_classes; end

    # source://test-unit//lib/test/unit/assertions.rb#2108
    def register_inspector_class(inspector_class); end

    # source://test-unit//lib/test/unit/assertions.rb#2112
...
# source://test-unit//lib/test/unit/assertions.rb#2275
class Test::Unit::Assertions::AssertionMessage::Literal
  # @return [Literal] a new instance of Literal
  #
  # source://test-unit//lib/test/unit/assertions.rb#2276
  def initialize(value); end

  # source://test-unit//lib/test/unit/assertions.rb#2280
  def inspect; end
...
# source://test-unit//lib/test/unit/assertions.rb#2295
class Test::Unit::Assertions::AssertionMessage::MaybeContainer
  # @return [MaybeContainer] a new instance of MaybeContainer
  #
  # source://test-unit//lib/test/unit/assertions.rb#2296
  def initialize(value, &formatter); end

  # source://test-unit//lib/test/unit/assertions.rb#2301
  def inspect; end
...
# source://test-unit//lib/test/unit/assertions.rb#2157
class Test::Unit::Assertions::AssertionMessage::NumericInspector
  # @return [NumericInspector] a new instance of NumericInspector
  #
  # source://test-unit//lib/test/unit/assertions.rb#2166
  def initialize(numeric, inspected_objects); end

  # source://test-unit//lib/test/unit/assertions.rb#2171
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2175
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2179
  def pretty_print_cycle(q); end

  class << self
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2161
    def target?(object); end
...
# source://test-unit//lib/test/unit/assertions.rb#2313
class Test::Unit::Assertions::AssertionMessage::Template
  # @return [Template] a new instance of Template
  #
  # source://test-unit//lib/test/unit/assertions.rb#2321
  def initialize(parts); end

  # Returns the value of attribute count.
  #
  # source://test-unit//lib/test/unit/assertions.rb#2319
  def count; end

  # source://test-unit//lib/test/unit/assertions.rb#2326
  def result(parameters); end

  private

  # source://test-unit//lib/test/unit/assertions.rb#2347
  def concatenatable(text, encoding); end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2314
...
# @private
#
# source://test-unit//lib/test/unit/assertions.rb#69
...
class Test::Unit::Assertions::ThrowTagExtractor
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#820
  def initialize(error); end

  # source://test-unit//lib/test/unit/assertions.rb#824
  def extract_tag; end

  private

  # source://test-unit//lib/test/unit/assertions.rb#839
...
# source://test-unit//lib/test/unit/assertions.rb#814
...
class Test::Unit::AutoRunner
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#466
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#509
  def load_config(file); end

  # source://test-unit//lib/test/unit/autorunner.rb#531
  def load_plain_text_config(file); end

  # source://test-unit//lib/test/unit/autorunner.rb#209
  def options; end
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#197
  def process_args(args = T.unsafe(nil)); end

  # source://test-unit//lib/test/unit/autorunner.rb#484
  def run; end
...
# source://test-unit//lib/test/unit/autorunner.rb#632
class Test::Unit::AutoRunner::GCStressListener
  # source://test-unit//lib/test/unit/autorunner.rb#633
...
class Test::Unit::AutoRunner::StopOnFailureListener
  # source://test-unit//lib/test/unit/autorunner.rb#625
  def attach_to_mediator(mediator); end
...
class Test::Unit::Color::Error < ::StandardError
  class << self
    private
...
class Test::Unit::Color::ParseError < ::Test::Unit::Color::Error
  class << self
    private
...
module Test::Unit::Util::BacktraceFilter
  ...
  # source://test-unit//lib/test/unit/util/backtracefilter.rb#23
...
# source://test-unit//lib/test/unit/util/backtracefilter.rb#17
Test::Unit::Util::BacktraceFilter::POWERASSERT_PREFIX = T.let(T.unsafe(nil), Array)

# source://test-unit//lib/test/unit/util/backtracefilter.rb#13
...
# source://test-unit//lib/test/unit/util/backtracefilter.rb#15
