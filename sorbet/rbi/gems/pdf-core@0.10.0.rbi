...
class PDF::Core::FilterList
  ...
  # @return [Array<Array<(Symbol, [Hash, nil])>>]
  #
  # source://pdf-core//lib/pdf/core/filter_list.rb#55
  def to_a; end
...
class PDF::Core::ObjectStore
  ...
  # @overload push
  #
  # source://pdf-core//lib/pdf/core/object_store.rb#95
  def <<(*args); end
  ...
  # @return [Integer]
  #
  # source://pdf-core//lib/pdf/core/object_store.rb#121
  def length; end
...
module PDF::Core::Text
  ...
  # @return [Numeric]
  #
  # source://pdf-core//lib/pdf/core/text.rb#113
  def default_leading=(number = T.unsafe(nil)); end
  ...
  # @return [:rtl]
  #
  # source://pdf-core//lib/pdf/core/text.rb#147
  def text_direction=(direction = T.unsafe(nil)); end
