...
# source://sdoc//lib/sdoc/generator.rb#12
class RDoc::ClassModule < ::RDoc::Context
  # @return [Boolean]
  #
  # source://sdoc//lib/sdoc/generator.rb#13
  def with_documentation?; end
end

# source://sdoc//lib/sdoc/generator.rb#23
class RDoc::Generator::SDoc
  ...
  #
  # source://sdoc//lib/sdoc/generator.rb#77
  def initialize(store, options); end

  # Returns the value of attribute base_dir.
  #
  # source://sdoc//lib/sdoc/generator.rb#43
  def base_dir; end

  # For compatibility with RDoc < 6.13.0
  #
  # source://sdoc//lib/sdoc/generator.rb#110
  def class_dir; end

  # For compatibility with RDoc < 6.13.0
  #
  # source://sdoc//lib/sdoc/generator.rb#115
  def file_dir; end

  # source://sdoc//lib/sdoc/generator.rb#92
  def generate; end

  # Returns the value of attribute options.
  #
  # source://sdoc//lib/sdoc/generator.rb#45
  def options; end

  # The RDoc::Store that is the source of the generated content
  #
  # source://sdoc//lib/sdoc/generator.rb#50
  def store; end
...
class RDoc::Options
  ...
  #
  # source://sdoc//lib/sdoc/generator.rb#20
...
# source://sdoc//lib/sdoc.rb#3
module SDoc; end

# source://sdoc//lib/sdoc/github.rb#1
module SDoc::GitHub
  # source://sdoc//lib/sdoc/github.rb#2
  ...
  # @return [Boolean]
  #
  # source://sdoc//lib/sdoc/github.rb#21
  def have_git?; end

  # source://sdoc//lib/sdoc/github.rb#26
  def last_commit_sha1; end

  # source://sdoc//lib/sdoc/github.rb#45
  def path_relative_to_repository(path); end

  # source://sdoc//lib/sdoc/github.rb#51
  def path_to_git_dir(path); end

  # source://sdoc//lib/sdoc/github.rb#34
  def repository_url(path); end
end

# source://sdoc//lib/sdoc/helpers.rb#1
module SDoc::Helpers
  # @yield [group]
  #
  # source://sdoc//lib/sdoc/helpers.rb#2
  ...
  #
  # source://sdoc//lib/sdoc/helpers.rb#23
  ...
  #
  # source://sdoc//lib/sdoc/helpers.rb#31
  def truncate(text, options = T.unsafe(nil)); end

  protected

  # source://sdoc//lib/sdoc/helpers.rb#41
  def group_name(name); end
end

# source://sdoc//lib/sdoc/templatable.rb#3
module SDoc::Templatable
  ...
  #
  # source://sdoc//lib/sdoc/templatable.rb#7
  ...
  #
  # source://sdoc//lib/sdoc/templatable.rb#29
  ...
  # Both +templatefile+ and +outfile+ should be Pathname-like objects.
  #
  # source://sdoc//lib/sdoc/templatable.rb#38
  def render_template(templatefile, context, outfile); end
end

# source://sdoc//lib/sdoc/version.rb#2
