...
module Kgio::DefaultWaiters; end
...
class Kgio::TCPServer < ::TCPServer; end
...
class Unicorn::HttpParser
  # source://unicorn//lib/unicorn/http_request.rb#4
  def initialize; end
...
# Unicorn::HttpParser::TCPI = T.let(T.unsafe(nil), Raindrops::TCP_Info)  # Commented out - Raindrops not installed
...
module Unicorn::SocketHelper
  ...
  class << self
    ...
    # Warning: TCP sockets may not always return the name given to it.
    #
    # source://unicorn//lib/unicorn/socket_helper.rb#198
    def sock_name(sock); end

    # returns rfc2732-style (e.g. "[::1]:666") addresses for IPv6
    #
    # source://unicorn//lib/unicorn/socket_helper.rb#175
    def tcp_name(sock); end
  end
end
...
class Unicorn::TmpIO < ::File
  ...
  #
  # source://unicorn//lib/unicorn/tmpio.rb#32
  def close!; end
