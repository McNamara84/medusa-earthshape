...
#
# source://cancancan//lib/cancan/version.rb#3
module CanCan
  class << self
    ...
    #
    # source://cancancan//lib/cancan/config.rb#50
    def accessible_by_strategy; end

    # source://cancancan//lib/cancan/config.rb#67
    def accessible_by_strategy=(value); end

    # source://cancancan//lib/cancan/config.rb#56
    def default_accessible_by_strategy; end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/config.rb#97
    def does_not_support_subquery_strategy?; end

    # You can disable the rules compressor if it's causing unexpected issues.
    #
    # source://cancancan//lib/cancan/config.rb#15
    def rules_compressor_enabled; end

    # source://cancancan//lib/cancan/config.rb#21
    def rules_compressor_enabled=(value); end

    # source://cancancan//lib/cancan/config.rb#4
    def valid_accessible_by_strategies; end

    # @raise [ArgumentError]
    #
    # source://cancancan//lib/cancan/config.rb#91
    def validate_accessible_by_strategy!(value); end

    # source://cancancan//lib/cancan/config.rb#77
    def with_accessible_by_strategy(value); end

    # source://cancancan//lib/cancan/config.rb#25
    def with_rules_compressor_enabled(value); end
  end
end
...
#   end
#
# source://cancancan//lib/cancan/ability/rules.rb#4
module CanCan::Ability
  ...
  # source://cancancan//lib/cancan/ability.rb#185
  def attributes_for(action, subject); end

  # See ControllerAdditions#authorize! for documentation.
  #
  # source://cancancan//lib/cancan/ability.rb#176
  ...
  #   end
  #
  # source://cancancan//lib/cancan/ability.rb#144
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/ability.rb#74
  ...
  #   end
  #
  # source://cancancan//lib/cancan/ability.rb#160
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/ability.rb#87
  def cannot?(*args); end

  # source://cancancan//lib/cancan/ability.rb#275
  def extract_rule_in_permissions(permissions_list, rule); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/ability.rb#193
  ...
  #
  # source://cancancan//lib/cancan/ability.rb#248
  def merge(ability); end

  # source://cancancan//lib/cancan/ability.rb#170
  ...
  #   }
  #
  # source://cancancan//lib/cancan/ability.rb#266
  def permissions; end
  ...
  # @raise [Error]
  #
  # source://cancancan//lib/cancan/ability.rb#165
  def validate_target(target); end

  private

  # source://cancancan//lib/cancan/ability.rb#303
  ...
  #
  # source://cancancan//lib/cancan/ability.rb#295
  def extract_subjects(subject); end

  # source://cancancan//lib/cancan/ability.rb#286
  def unauthorized_message_keys(action, subject); end
end

# source://cancancan//lib/cancan/ability/actions.rb#5
module CanCan::Ability::Actions
  ...
  #
  # source://cancancan//lib/cancan/ability/actions.rb#35
  def alias_action(*args); end

  # Returns a hash of aliased actions. The key is the target and the value is an array of actions aliasing the key.
  #
  # source://cancancan//lib/cancan/ability/actions.rb#43
  def aliased_actions; end

  # Removes previously aliased actions including the defaults.
  #
  # source://cancancan//lib/cancan/ability/actions.rb#48
  ...
  #
  # source://cancancan//lib/cancan/ability/actions.rb#64
  def aliases_for_action(action); end

  # source://cancancan//lib/cancan/ability/actions.rb#54
  ...
  #
  # source://cancancan//lib/cancan/ability/actions.rb#79
  def expand_actions(actions); end

  # source://cancancan//lib/cancan/ability/actions.rb#72
  def expanded_actions; end
end

# source://cancancan//lib/cancan/ability/rules.rb#5
module CanCan::Ability::Rules
  ...
  #
  # source://cancancan//lib/cancan/ability/rules.rb#10
  def rules; end

  private

  # source://cancancan//lib/cancan/ability/rules.rb#16
  def add_rule(rule); end

  # source://cancancan//lib/cancan/ability/rules.rb#21
  def add_rule_to_index(rule, position); end

  # Optimizes the order of the rules, so that rules with the :all subject are evaluated first.
  #
  # source://cancancan//lib/cancan/ability/rules.rb#82
  def optimize_order!(rules); end

  # source://cancancan//lib/cancan/ability/rules.rb#47
  def possible_relevant_rules(subject); end

  # Returns an array of Rule instances which match the action and subject
  # This does not take into consideration any hash conditions or block statements
  #
  # source://cancancan//lib/cancan/ability/rules.rb#35
  def relevant_rules(action, subject); end

  # source://cancancan//lib/cancan/ability/rules.rb#59
  def relevant_rules_for_match(action, subject); end

  # source://cancancan//lib/cancan/ability/rules.rb#69
  def relevant_rules_for_query(action, subject); end
end

# source://cancancan//lib/cancan/ability/strong_parameter_support.rb#5
module CanCan::Ability::StrongParameterSupport
  ...
  #
  # source://cancancan//lib/cancan/ability/strong_parameter_support.rb#12
  def permitted_attributes(action, subject); end

  private

  # source://cancancan//lib/cancan/ability/strong_parameter_support.rb#30
  def get_attributes(rule, subject); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/ability/strong_parameter_support.rb#25
...
#
# source://cancancan//lib/cancan/exceptions.rb#46
class CanCan::AccessDenied < ::CanCan::Error
  ...
  #
  # source://cancancan//lib/cancan/exceptions.rb#47
  def action; end
  ...
  #
  # source://cancancan//lib/cancan/exceptions.rb#48
  def default_message=(_arg0); end

  # source://cancancan//lib/cancan/exceptions.rb#62
  def inspect; end
...
#
# source://cancancan//lib/cancan/exceptions.rb#17
...
module CanCan::ConditionsMatcher
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#6
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#111
  def array_like_matches_condition_hash?(attribute, value); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#128
  def call_block_with_all(action, subject, *extra_args); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#90
  def condition_match?(attribute, value); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#140
  def conditions_empty?; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#103
  def hash_condition_match?(attribute, value); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#70
  def matches_all_conditions?(adapter, subject, conditions); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#21
  def matches_block_conditions(subject, attribute, *extra_args); end
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#58
  def matches_conditions_hash?(subject, conditions = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#80
  def matches_hash_conditions?(adapter, subject, conditions); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#31
  def matches_non_block_conditions(subject); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#136
  def model_adapter(subject); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#39
  def nested_subject_matches_conditions?(subject_hash); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#16
  def subject_class?(subject); end
end
...
#
# source://cancancan//lib/cancan/controller_additions.rb#6
module CanCan::ControllerAdditions
  ...
  #
  # source://cancancan//lib/cancan/controller_additions.rb#342
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/controller_additions.rb#389
  def cannot?(*args); end
  ...
  #
  # source://cancancan//lib/cancan/controller_additions.rb#358
  def current_ability; end

  class << self
    # @private
    #
    # source://cancancan//lib/cancan/controller_additions.rb#300
...
# source://cancancan//lib/cancan/controller_additions.rb#7
module CanCan::ControllerAdditions::ClassMethods
  ...
  #
  # source://cancancan//lib/cancan/controller_additions.rb#185
  def authorize_resource(*args); end

  # source://cancancan//lib/cancan/controller_additions.rb#291
  def cancan_resource_class; end

  # source://cancancan//lib/cancan/controller_additions.rb#295
  ...
  #
  # source://cancancan//lib/cancan/controller_additions.rb#265
  ...
  #   end
  #
  # source://cancancan//lib/cancan/controller_additions.rb#15
  ...
  #   Passing +true+ will use prepend_before_action instead of a normal before_action.
  #
  # source://cancancan//lib/cancan/controller_additions.rb#121
  ...
  #
  # source://cancancan//lib/cancan/controller_additions.rb#286
  ...
  #
  # source://cancancan//lib/cancan/controller_additions.rb#229
  ...
  # You can also pass the resource name as the first argument to skip that resource.
  #
  # source://cancancan//lib/cancan/controller_additions.rb#198
  ...
  # You can also pass the resource name as the first argument to skip that resource.
  #
  # source://cancancan//lib/cancan/controller_additions.rb#213
...
#
# source://cancancan//lib/cancan/controller_resource.rb#8
class CanCan::ControllerResource
  ...
  #
  # source://cancancan//lib/cancan/controller_resource.rb#25
  def initialize(controller, *args); end

  # source://cancancan//lib/cancan/controller_resource.rb#37
  def authorize_resource; end

  # source://cancancan//lib/cancan/controller_resource.rb#32
  def load_and_authorize_resource; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/controller_resource.rb#43
  def parent?; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/controller_resource.rb#47
  def skip?(behavior); end

  protected

  # source://cancancan//lib/cancan/controller_resource.rb#119
  def collection_actions; end

  # source://cancancan//lib/cancan/controller_resource.rb#105
  def collection_instance; end

  # source://cancancan//lib/cancan/controller_resource.rb#101
  def collection_instance=(instance); end

  # source://cancancan//lib/cancan/controller_resource.rb#115
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/controller_resource.rb#81
  def member_action?; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/controller_resource.rb#111
  ...
  #
  # source://cancancan//lib/cancan/controller_resource.rb#60
  def resource_class; end

  # source://cancancan//lib/cancan/controller_resource.rb#87
  def resource_class_with_parent; end

  # source://cancancan//lib/cancan/controller_resource.rb#95
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/controller_resource.rb#129
  def action_exists_in?(options); end

  # source://cancancan//lib/cancan/controller_resource.rb#133
  def adapter; end

  # source://cancancan//lib/cancan/controller_resource.rb#137
  def current_ability; end

  class << self
    # source://cancancan//lib/cancan/controller_resource.rb#11
    def add_before_action(controller_class, method, *args); end

    # source://cancancan//lib/cancan/controller_resource.rb#21
    def before_callback_name(options); end
  end
end

# source://cancancan//lib/cancan/controller_resource_builder.rb#4
module CanCan::ControllerResourceBuilder
  protected

  # source://cancancan//lib/cancan/controller_resource_builder.rb#12
  def assign_attributes(resource); end

  # source://cancancan//lib/cancan/controller_resource_builder.rb#7
  def build_resource; end

  # source://cancancan//lib/cancan/controller_resource_builder.rb#20
  def initial_attributes; end
end

# source://cancancan//lib/cancan/controller_resource_finder.rb#4
module CanCan::ControllerResourceFinder
  protected

  # source://cancancan//lib/cancan/controller_resource_finder.rb#21
  def find_by_dynamic_finder; end

  # source://cancancan//lib/cancan/controller_resource_finder.rb#26
  def find_by_find_by_finder; end

  # source://cancancan//lib/cancan/controller_resource_finder.rb#7
  def find_resource; end

  # source://cancancan//lib/cancan/controller_resource_finder.rb#17
  def find_resource_using_find_by; end

  # source://cancancan//lib/cancan/controller_resource_finder.rb#30
  def id_param; end

  # source://cancancan//lib/cancan/controller_resource_finder.rb#34
  def id_param_key; end
end

# source://cancancan//lib/cancan/controller_resource_loader.rb#8
module CanCan::ControllerResourceLoader
  ...
  # source://cancancan//lib/cancan/controller_resource_loader.rb#14
  ...
  # source://cancancan//lib/cancan/controller_resource_loader.rb#50
  def fetch_parent(name); end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#102
  def load_collection; end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#106
  def load_resource_instance; end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#26
  def new_actions; end
  ...
  # source://cancancan//lib/cancan/controller_resource_loader.rb#75
  def resource_base_through; end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#67
  def resource_base_through_parent_resource; end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#42
  def resource_params; end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#30
  def resource_params_by_key(key); end

  # source://cancancan//lib/cancan/controller_resource_loader.rb#36
  def resource_params_by_namespaced_name; end

  private

  # source://cancancan//lib/cancan/controller_resource_loader.rb#116
  def extract_key(value); end
end

# source://cancancan//lib/cancan/controller_resource_name_finder.rb#4
module CanCan::ControllerResourceNameFinder
  protected

  # source://cancancan//lib/cancan/controller_resource_name_finder.rb#15
  def name; end

  # source://cancancan//lib/cancan/controller_resource_name_finder.rb#7
  def name_from_controller; end

  # source://cancancan//lib/cancan/controller_resource_name_finder.rb#19
  def namespace; end

  # source://cancancan//lib/cancan/controller_resource_name_finder.rb#11
  def namespaced_name; end
end

# source://cancancan//lib/cancan/controller_resource_sanitizer.rb#4
module CanCan::ControllerResourceSanitizer
  protected

  # source://cancancan//lib/cancan/controller_resource_sanitizer.rb#24
  def params_method; end

  # source://cancancan//lib/cancan/controller_resource_sanitizer.rb#18
  def params_methods; end

  # source://cancancan//lib/cancan/controller_resource_sanitizer.rb#7
  def sanitize_parameters; end
end

# A general CanCan exception
#
# source://cancancan//lib/cancan/exceptions.rb#5
class CanCan::Error < ::StandardError; end

# Raised when removed code is called, an alternative solution is provided in message.
#
# source://cancancan//lib/cancan/exceptions.rb#11
...
# source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#5
class CanCan::ModelAdapters::AbstractAdapter
  # @return [AbstractAdapter] a new instance of AbstractAdapter
  #
  # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#66
  def initialize(model_class, rules); end

  # @raise [NotImplemented]
  #
  # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#71
  def database_records; end

  # Returns the value of attribute model_class.
  #
  # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#6
  def model_class; end

  class << self
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#13
    def adapter_class(model_class); end

    # Override if you need custom find behavior
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#23
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#18
    def for_class?(_member_class); end

    # @private
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#8
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#62
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#34
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#51
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#57
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#29
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#46
    ...
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#39
    def parent_condition_name(parent, _child); end
  end
end

# source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#5
class CanCan::ModelAdapters::ActiveRecord4Adapter < ::CanCan::ModelAdapters::ActiveRecordAdapter
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#37
  def build_joins_relation(relation, *_where_conditions); end

  # Rails 4.2 deprecates `sanitize_sql_hash_for_conditions`
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#42
  def sanitize_sql(conditions); end

  # source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#50
  def sanitize_sql_activerecord4(conditions); end

  class << self
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#9
    def for_class?(model_class); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#17
    def matches_condition?(subject, name, value); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_4_adapter.rb#13
    def override_condition_matching?(subject, name, _value); end
  end
end

# source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#5
class CanCan::ModelAdapters::ActiveRecord5Adapter < ::CanCan::ModelAdapters::ActiveRecord4Adapter
  private

  # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#24
  def build_joins_relation(relation, *where_conditions); end

  # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#33
  def sanitize_sql(conditions); end

  # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#41
  def sanitize_sql_activerecord5(conditions); end

  # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#28
  def strategy_class; end

  # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#49
  def visit_nodes(node); end

  class << self
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#8
    def for_class?(model_class); end
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_5_adapter.rb#14
    def matches_condition?(subject, name, value); end
  end
end

# source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#8
class CanCan::ModelAdapters::ActiveRecordAdapter < ::CanCan::ModelAdapters::AbstractAdapter
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#19
  def initialize(model_class, rules); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#138
  def build_relation(*where_conditions); end

  # Returns the value of attribute compressed_rules.
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#17
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#112
  def conditions; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#128
  def database_records; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#122
  def extract_multiple_conditions(conditions_extractor, rules); end

  # Returns the associations used in conditions for the :joins option of a search.
  # See ModelAdditions#accessible_by
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#148
  def joins; end
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#159
  def deep_clean(joins_hash); end

  # Takes two hashes and does a deep merge.
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#164
  def deep_merge(base_hash, added_hash); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#209
  def false_sql; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#189
  def merge_conditions(sql, conditions_hash, behavior); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#197
  def merge_non_empty_conditions(behavior, conditions_hash, sql); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#174
  def override_scope; end

  # @raise [Error]
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#182
  def raise_override_scope_error; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#217
  def sanitize_sql(conditions); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#213
  def true_sql; end

  class << self
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#74
    def child_association_to_parent(parent, child); end

    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#64
    def matching_parent_child_polymorphic_association(parent_assoc, child_class); end

    # parent_id condition can be an array of integer or one integer, we check the parent against this
    #
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#38
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#33
    def override_nested_subject_conditions_matching?(parent, child, all_conditions); end

    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#46
    def parent_child_conditions(parent, child, all_conditions); end

    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#92
    def parent_condition_name(parent, child); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#9
    def version_greater_or_equal?(version); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#13
    def version_lower?(version); end
  end
end

# source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#9
class CanCan::ModelAdapters::ConditionsExtractor
  # @return [ConditionsExtractor] a new instance of ConditionsExtractor
  #
  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#10
  def initialize(model_class); end

  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#15
  def tableize_conditions(conditions, model_class = T.unsafe(nil), path_to_key = T.unsafe(nil)); end

  private

  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#68
  def add_to_cache(table_alias, relation_name, path_to_key); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#64
  def already_used?(table_alias, relation_name, path_to_key); end

  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#37
  def calculate_nested(model_class, result_hash, relation_name, value, path_to_key); end

  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#30
  def calculate_result_hash(key, model_class, path_to_key, result_hash, value); end

  # source://cancancan//lib/cancan/model_adapters/conditions_extractor.rb#50
  def generate_table_alias(model_class, relation_name, path_to_key); end
end

# source://cancancan//lib/cancan/model_adapters/conditions_normalizer.rb#7
class CanCan::ModelAdapters::ConditionsNormalizer
  class << self
    # source://cancancan//lib/cancan/model_adapters/conditions_normalizer.rb#9
    def normalize(model_class, rules); end

    # source://cancancan//lib/cancan/model_adapters/conditions_normalizer.rb#13
    def normalize_conditions(model_class, conditions); end

    private

    # source://cancancan//lib/cancan/model_adapters/conditions_normalizer.rb#28
    def calculate_result_hash(model_class, key, value); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/conditions_normalizer.rb#43
    def normalizable_association?(reflection); end
  end
end

# source://cancancan//lib/cancan/model_adapters/default_adapter.rb#5
class CanCan::ModelAdapters::DefaultAdapter < ::CanCan::ModelAdapters::AbstractAdapter; end

# source://cancancan//lib/cancan/model_adapters/sti_normalizer.rb#7
class CanCan::ModelAdapters::StiNormalizer
  class << self
    # source://cancancan//lib/cancan/model_adapters/sti_normalizer.rb#9
    ...
    #
    # source://cancancan//lib/cancan/model_adapters/sti_normalizer.rb#32
    def build_rule_for_subclass(rule, subject); end

    # source://cancancan//lib/cancan/model_adapters/sti_normalizer.rb#24
    def update_rule(subject, rule, rules_cache); end
  end
end

# source://cancancan//lib/cancan/model_adapters/strategies/base.rb#3
class CanCan::ModelAdapters::Strategies; end

# source://cancancan//lib/cancan/model_adapters/strategies/base.rb#4
class CanCan::ModelAdapters::Strategies::Base
  # @return [Base] a new instance of Base
  #
  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#20
  def initialize(adapter:, relation:, where_conditions:); end

  # Returns the value of attribute adapter.
  #
  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#5
  def adapter; end

  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#26
  def aliased_table_name; end

  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#7
  def compressed_rules(*_arg0, **_arg1, &_arg2); end

  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#17
  def connection(*_arg0, **_arg1, &_arg2); end

  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#7
  def extract_multiple_conditions(*_arg0, **_arg1, &_arg2); end
  ...
  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#18
  ...
  # source://cancancan//lib/cancan/model_adapters/strategies/base.rb#7
  def quoted_primary_key(*_arg0, **_arg1, &_arg2); end
...
# source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#6
class CanCan::ModelAdapters::Strategies::JoinedAliasEachRuleAsExistsSubquery < ::CanCan::ModelAdapters::Strategies::Base
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#78
  def current_path_to_hash(current_path); end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#16
  def double_exists_sql; end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#7
  def execute!; end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#55
  def extra_joins_recursive(current_path, conditions, joins, left_joins); end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#67
  def extra_joins_recursive_merge_joins(current_path, value, joins, left_joins); end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#47
  def extract_joins_from_rule(rule); end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#27
  def sub_query_for_rule(rule); end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_each_rule_as_exists_subquery.rb#34
  def sub_query_for_rules_and_join_hashes(rule_where_conditions, joins_hash, left_joins_hash); end
end

# source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_exists_subquery.rb#6
class CanCan::ModelAdapters::Strategies::JoinedAliasExistsSubquery < ::CanCan::ModelAdapters::Strategies::Base
  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_exists_subquery.rb#7
  def execute!; end

  # source://cancancan//lib/cancan/model_adapters/strategies/joined_alias_exists_subquery.rb#16
  def joined_alias_exists_subquery_inner_query; end
end

# source://cancancan//lib/cancan/model_adapters/strategies/left_join.rb#4
class CanCan::ModelAdapters::Strategies::LeftJoin < ::CanCan::ModelAdapters::Strategies::Base
  # source://cancancan//lib/cancan/model_adapters/strategies/left_join.rb#5
  def execute!; end
end

# source://cancancan//lib/cancan/model_adapters/strategies/subquery.rb#4
class CanCan::ModelAdapters::Strategies::Subquery < ::CanCan::ModelAdapters::Strategies::Base
  # source://cancancan//lib/cancan/model_adapters/strategies/subquery.rb#9
  def build_joins_relation_subquery(where_conditions); end

  # source://cancancan//lib/cancan/model_adapters/strategies/subquery.rb#5
  def execute!; end
end

# This module adds the accessible_by class method to a model. It is included in the model adapters.
#
# source://cancancan//lib/cancan/model_additions.rb#5
module CanCan::ModelAdditions
  ...
  class << self
    # @private
    #
    # source://cancancan//lib/cancan/model_additions.rb#30
    def included(base); end
  end
end

# source://cancancan//lib/cancan/model_additions.rb#6
...
module CanCan::Relevant
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/relevant.rb#13
  def matches_action?(action); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/relevant.rb#17
  def matches_subject?(subject); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/relevant.rb#21
...
#
# source://cancancan//lib/cancan/rule.rb#11
class CanCan::Rule
  ...
  #
  # source://cancancan//lib/cancan/rule.rb#22
  ...
  # source://cancancan//lib/cancan/rule.rb#76
  ...
  # source://cancancan//lib/cancan/rule.rb#86
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#51
  def can_rule?; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#55
  def cannot_catch_all?; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#59
  def catch_all?; end
  ...
  #
  # source://cancancan//lib/cancan/rule.rb#16
  ...
  # source://cancancan//lib/cancan/rule.rb#38
  def inspect; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#96
  def matches_attributes?(attribute); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#64
  def only_block?; end
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#72
  def with_scope?; end
  ...
  #
  # source://cancancan//lib/cancan/rule.rb#123
  def condition_and_block_check(conditions, block, action, subject); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#105
  def matches_action?(action); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#109
  def matches_subject?(subject); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/rule.rb#113
  def matches_subject_class?(subject); end

  # source://cancancan//lib/cancan/rule.rb#117
  def parse_attributes_from_extra_args(args); end

  # source://cancancan//lib/cancan/rule.rb#130
  def wrap(object); end
end

# source://cancancan//lib/cancan/rules_compressor.rb#5
class CanCan::RulesCompressor
  # @return [RulesCompressor] a new instance of RulesCompressor
  #
  # source://cancancan//lib/cancan/rules_compressor.rb#8
  def initialize(rules); end

  # source://cancancan//lib/cancan/rules_compressor.rb#13
  ...
  #
  # source://cancancan//lib/cancan/rules_compressor.rb#31
  def simplify(rules); end
end

# source://cancancan//lib/cancan/unauthorized_message_resolver.rb#4
module CanCan::UnauthorizedMessageResolver
  # source://cancancan//lib/cancan/unauthorized_message_resolver.rb#15
  def translate_subject(subject); end

  # source://cancancan//lib/cancan/unauthorized_message_resolver.rb#5
  def unauthorized_message(action, subject); end
end

# source://cancancan//lib/cancan/version.rb#4
CanCan::VERSION = T.let(T.unsafe(nil), String)

# Raised when using a wrong association name
#
# source://cancancan//lib/cancan/exceptions.rb#23
class CanCan::WrongAssociationName < ::CanCan::Error; end

# source://cancancan//lib/cancancan.rb#5
module CanCanCan; end

# source://cancancan//lib/cancan/sti_detector.rb#3
class StiDetector
  class << self
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/sti_detector.rb#4
...
#
# source://cancancan//lib/cancan/class_matcher.rb#6
class SubjectClassMatcher
  class << self
    # source://cancancan//lib/cancan/class_matcher.rb#25
    def matches_class_or_is_related(subject, sub); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/class_matcher.rb#7
    def matches_subject_class?(subjects, subject); end

    # source://cancancan//lib/cancan/class_matcher.rb#14
