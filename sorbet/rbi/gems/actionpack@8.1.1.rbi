...
class ActionDispatch::InvalidParameterError < ::ActionDispatch::ParamError
  class << self
    private
...
class ActionDispatch::ParameterTypeError < ::ActionDispatch::ParamError
  class << self
    private
...
class ActionDispatch::ParamsTooDeepError < ::ActionDispatch::ParamError
  class << self
    private
